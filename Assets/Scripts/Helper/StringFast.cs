...
public class StringFast
{
	...
	///<summary>Append a float without memory allocation.</summary>
	public StringFast Append (double valueF)
	{
		double value = valueF;
		m_isStringGenerated = false;
		ReallocateIFN (64); // Check we have enough buffer allocated to handle any float number
	...
	///<summary>Append a float without memory allocation.</summary>
	public StringFast Append (double valueF, int unit)
	{
		double value = valueF;
		m_isStringGenerated = false;
		ReallocateIFN (64); // Check we have enough buffer allocated to handle any float number
