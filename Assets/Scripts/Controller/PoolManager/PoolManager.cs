...
public class PoolManager : Singleton<PoolManager>
{
    ...
    public Transform PoolySpawn(Transform prefab, Vector3 position, Vector3 rotation)
    {
        return Pooly.Spawn(prefab, position, rotation); ;
    }
    ...
    public Transform PoolySpawn(string itemName, Vector3 position, Vector3 rotation)
    {
        return Pooly.Spawn(itemName, position, rotation); 
    }

    public Transform PoolySpawn(Transform prefab, Vector3 position, Quaternion rotation, Transform parent)
    {
    ...
    public Transform PoolySpawn(string itemName, Vector3 position, Quaternion rotation, Transform parent)
    {
