...
public static class PlayerData
{
   ...
   // public static int LastLevelUnlocked;
    ...
    public static void SaveItemStatic (ObscuredInt item_level, int xColumn, int yRow)
    {
    ...
    public static void SaveItemProfitCoefficient (ObscuredInt itemLevel, int numberBuy)
    {
    ...
    public static void SaveItemUpgradeProfitCoefficient (ObscuredInt item_level, int number_buy)
    {
    ...
    public static int GetNumberBuyItemProfitCoefficient (ObscuredInt itemLevel)
    {
        return ShopItemProfitPercent[itemLevel - 1];
    }

    public static int GetNumberUpgradeItemProfitCoefficient (ObscuredInt item_level)
    {
    ...
    private static ObscuredInt ObscuredEncryptKey=20200911;

    private const string LastLevelUnlockedKey = "LastLevelUnlocked";
    private static ObscuredInt lastLevelUnlocked=-1;
    public static ObscuredInt LastLevelUnlocked
    {
        set
        {
            lastLevelUnlocked = value;

           Monster.Data.GameData.SaveData(LastLevelUnlockedKey, ObscuredInt.Encrypt(lastLevelUnlocked, ObscuredEncryptKey));//
        }
        get
        {
            ...
            {
                int saveLevel = -1;
                lastLevelUnlocked = Monster.Data.GameData.GetData(LastLevelUnlockedKey, saveLevel);
                if (lastLevelUnlocked == -1)
                {
                    return 1;
                }
                lastLevelUnlocked= ObscuredInt.Decrypt(lastLevelUnlocked, ObscuredEncryptKey);
    ...
    private const string CarTotalAmountKey = "CarTotalAmount";
    private static ObscuredInt carTotalAmount = -1;
    public static ObscuredInt CarTotalAmountdDfault
    {
        get { return 20; }
    }

    public static ObscuredInt CarTotalAmount
    {
        set
        {
            carTotalAmount = value;
            Monster.Data.GameData.SaveData(CarTotalAmountKey, ObscuredInt.Encrypt(carTotalAmount, ObscuredEncryptKey));//
        }
        get
        {
            if (carTotalAmount == -1)
            {
                int saveLevel = -1;
                carTotalAmount = Monster.Data.GameData.GetData(CarTotalAmountKey, saveLevel);
                if (carTotalAmount == -1)
                {
                    return CarTotalAmountdDfault;
                }
                carTotalAmount = ObscuredInt.Decrypt(carTotalAmount, ObscuredEncryptKey);
    ...
    private const string CarCurreectAmountKey = "CarCurrectAmount";
    private static ObscuredInt carCurrectAmount = -1;

    public static ObscuredInt CarCurrectAmountdDfault
    {
        get { return 20; }
    }
    public static ObscuredInt CarCurrectAmount
    {
        set
        {
            carCurrectAmount = value;
            Monster.Data.GameData.SaveData(CarCurreectAmountKey, ObscuredInt.Encrypt(carCurrectAmount, ObscuredEncryptKey));//
            MessageDispatcher.SendMessage("UpdateCarAmount");
        }
        get
        {
            if (carCurrectAmount == -1)
            {
                int saveLevel = -1;
                carCurrectAmount = Monster.Data.GameData.GetData(CarCurreectAmountKey, saveLevel);
                if (carCurrectAmount == -1)
                {
                    return CarCurrectAmountdDfault;
                }
                carCurrectAmount = ObscuredInt.Decrypt(carCurrectAmount, ObscuredEncryptKey);
                return carCurrectAmount;
            }
            return carCurrectAmount;
        }
    }
