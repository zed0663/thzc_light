...
namespace Ez.Pooly
{
    ...
    /// </summary>
    [AddComponentMenu("Ez/Pooly/Pooly Despawner")]
    public class PoolyDespawner : MonoBehaviour
    {
        ...
        /// <para>Note: onlyWithTag needs to be true and you sould be in on of the following modes: Despawn After Collision / Trigger / Collision2D / Trigger2D.</para>
        /// </summary>
